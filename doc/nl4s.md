...
0x03d  | 1    | `ffff f--t` | f=osc2_fine_tune(0-xxx); t=osc1_mod_type(0-5)[^3]
...
0x047  | 1    | `rttt kkv-` | r=^; t=filter_type(0-6)[^4]; k=filter_kb_track(0-3); v=filter_velocity(0-1)
...
[^2]: Not all values are valid. See wave table in `nl4_wavetable.ods`  

[^3]: OSC1 Mod Type mapping:  
    `000` (`0x0`) = mod off  
    `001` (`0x1`) = FM1  
    `010` (`0x2`) = FM2  
    `011` (`0x3`) = FM3  
